...
#Stuart- I added a print statement to see what was going on with your code. It
#is close to working, but you are only summing over the outer edge of the pyramid.
...
#Stuart- You should check your code as submitted. There was a small error with
#your indentation of the return in your chain length. Return breaks loops, small
#always important to double check your code.
...
#Stuart- You copied the line numbers when copying the code and so it doesn't run.
#Be careful and always check that the code runs in the file that you are submitting.
...
"""
#Stuart- Similar to your earlier problem the return statement was indented inside your for loop.
#Check your original code.
